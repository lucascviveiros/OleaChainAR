...
namespace Mapbox.Examples
{
	...
	public class ForwardGeocodeUserInput : MonoBehaviour
	{
		...
		ReverseGeocodeResource _reverseGeo;
		...
		void BackToLocalPosition()
        {
			//MapboxAccess.Instance.Geocoder.Geocode(_reverseGeo, HandleGeocoderResponse);
